    ...
    public class ManageController : Controller
    {
        ...
        public async Task<ActionResult> Index(ManageMessageId? message)
        {
            ...
            var model = new IndexViewModel
            {
                ...
                TwoFactor = await UserManager
                    .GetTwoFactorEnabledAsync(userId),
        ...
        public async Task<ActionResult> ManageLogins(ManageMessageId? message)
        {
            ...
            var userLogins = await UserManager.GetLoginsAsync(
                User.Identity.GetUserId());
        ...
        public ActionResult LinkLogin(string provider)
        {
            ...
            // provider to link a login for the current user
        ...
        public async Task<ActionResult> LinkLoginCallback()
        {
            ...
            var result = await UserManager.AddLoginAsync(
                User.Identity.GetUserId(), loginInfo.Login);
