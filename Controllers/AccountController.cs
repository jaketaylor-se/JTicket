/*
 *  Controller for the Identity Framework account-related requests.
 */ 
...
namespace JTicket.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> VerifyCode(VerifyCodeViewModel model)
        {
            ...
            // the two factor codes. If a user enters incorrect codes for 
            // a specified amount of time then the user account will be 
            // locked out for a specified amount of time. You can 
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    // Send an email with this link string code = 
                    // await UserManager
                    ...
                    // user.Id, "Confirm your account", "Please confirm 
                    // your account by clicking <a href=\"" + callbackUrl
                    // + "\">here</a>");
            ...
            ForgotPasswordViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                // "Reset Password", "Please reset your password by clicking 
            ...
            string returnUrl)
        {
            ...
            var result = await SignInManager
                .ExternalSignInAsync(loginInfo, isPersistent: false);
            ...
            switch (result)
            {
                ...
                default:
                    ...
                    // then prompt the user to create an account
                    ViewBag.ReturnUrl = returnUrl;
            ...
            ExternalLoginConfirmationViewModel model, string returnUrl)
        {
            ...
            if (ModelState.IsValid)
            {
                // Get the information about the user from the 
