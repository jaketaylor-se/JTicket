/*
 *  Start up and configurations for third party logins.
 */
...
namespace JTicket
{
    public partial class Startup
    {
        ...
        public void ConfigureAuth(IAppBuilder app)
        {
            ...
            // store information about a user logging in with a third 
            ...
            app.UseCookieAuthentication(new CookieAuthenticationOptions
            {
                ...
                Provider = new CookieAuthenticationProvider
                {
                    ...
                    // stamp when the user logs in. This is a security 
                    // feature which is used when you change a password 
            ...
            // during the login process will be remembered on the device 
